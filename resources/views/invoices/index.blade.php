                ...
                <div class="btn-group position-static" role="group">
                    <div class="btn-group position-static text-nowrap" role="group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{request()->fullUrlWithQuery(['paid' => 2])}}">Payée</a></li>
                            <li><a class="dropdown-item" href="{{request()->fullUrlWithQuery(['paid' => 1])}}">En cours</a></li>
                            <li><a class="dropdown-item" href="{{request()->fullUrlWithQuery(['paid' => 3])}}">Non Payée</a></li>
                            <li>
