<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <li class="nav-item">
        <a class="nav-link @if(Route::currentRouteName() == 'order.index') active @endif" href="{{route('order.index')}}">
    ...
    <li class="nav-item">
        <a class="nav-link @if(Route::currentRouteName() == 'client.index') active @endif" href="{{route('client.index')}}">
