...
<div class="collapse navbar-collapse justify-content-between">
    ...
    <a class="navbar-brand me-1 me-sm-3" href="{{route('home')}}">
        ...
        <div class="d-flex align-items-center"><img src="{{asset('images/logo.png')}}" alt="KOKLEM" width="27" />
            <h5 class="logo-text ms-2 d-none d-sm-block">KOKLEM</h5>
        </div>
        </div>
    </a>
    </div>
    ...
    <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
        <input class="form-control search-input fuzzy-search rounded-pill form-control-sm" type="search" placeholder="Recherche..." aria-label="Search" />
    ...
    <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="card position-relative border-0">
            ...
            <div class="card-footer p-0">
                <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="#!"> <span class="me-2" data-feather="log-out"> </span>Déconnecter</a></div>
